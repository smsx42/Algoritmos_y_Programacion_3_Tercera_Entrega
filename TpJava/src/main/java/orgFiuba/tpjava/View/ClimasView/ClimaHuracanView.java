...
public class ClimaHuracanView extends ClimaView {

    public ClimaHuracanView(Clima clima){
        super(clima);
    ...
    public void mostrar(PokemonView pokemonView) {
        System.out.println(this.clima.getNombre() + ": Suma 10% al poder total del tipo Volador y resta 3% de la vida al resto de los tipos.");
